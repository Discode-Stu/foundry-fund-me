...
build:; forge build # semicolon is used if you want to do command on same line


# use toggle word wrap to wrap the code. option + z | or | cmnd shift P and type toggle word wrap
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv

# .PHONY is used to tell make that these are not files or folders, but commands
